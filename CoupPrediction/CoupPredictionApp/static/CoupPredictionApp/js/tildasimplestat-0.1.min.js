(function (w, d, $) {
    ...
    var userid = 'simple';
    var sessionid = 'simple';
    var isSendScrollEvent = {p10: 0, p25: 0, p50: 0, p75: 0, p90: 0};
    var dStartReadTime = new Date();
    var isWindowActive = !0;
    w.onVisibilityWindowChange = function (callback) {
        var visible = !0;
        if (!callback) {
    ...
    w.tildastat_scrollEvent = function () {
        ...
        p = parseInt((top - hh + wh) * 100 / (dh - hh - fh));
        if (p < 10) {
            return
        }
        if (p >= 10 && !isSendScrollEvent.p10) {
            tildaParams.page = '/tilda/scroll/10/';
            w.tildastat('pageview');
            isSendScrollEvent.p10 = !0
        } else {
            if (p >= 24) {
                if (isSendScrollEvent.p25 == 0) {
                    tildaParams.page = '/tilda/scroll/25/';
                    w.tildastat('pageview');
                    isSendScrollEvent.p25 = w.setTimeout(function () {
                        w.clearTimeout(isSendScrollEvent.p25);
                        isSendScrollEvent.p25 = -1
                    }, 5000);
                    return
                } else {
                    if (p < 51 && isSendScrollEvent.p25 == -1) {
            ...
            if (p >= 49) {
                if (isSendScrollEvent.p50 == 0) {
                    tildaParams.page = '/tilda/scroll/50/';
                    w.tildastat('pageview');
                    isSendScrollEvent.p50 = w.setTimeout(function () {
                        w.clearTimeout(isSendScrollEvent.p50);
                        isSendScrollEvent.p50 = -1
                    }, 5000);
                    return
                } else {
                    if (p < 76 && isSendScrollEvent.p50 == -1) {
            ...
            if (p >= 74) {
                if (isSendScrollEvent.p75 == 0) {
                    tildaParams.page = '/tilda/scroll/75/';
                    w.tildastat('pageview');
                    isSendScrollEvent.p75 = w.setTimeout(function () {
                        w.clearTimeout(isSendScrollEvent.p75);
                        isSendScrollEvent.p75 = -1
                    }, 5000);
                    return
                } else {
                    if (p < 91 && isSendScrollEvent.p75 == -1) {
            ...
            if (p >= 89) {
                if (isSendScrollEvent.p90 == 0) {
                    tildaParams.page = '/tilda/scroll/90/';
                    w.tildastat('pageview');
                    isSendScrollEvent.p90 = w.setTimeout(function () {
                        w.clearTimeout(isSendScrollEvent.p90);
                        isSendScrollEvent.p90 = -1
                    }, 5000);
                    return
                } else {
                    if (isSendScrollEvent.p90 == -1) {
    ...
    w.tildastat = function (event, params) {
        ...
        switch (event) {
            case 'create':
                ...
                tildaParams.params = {};
                if (typeof w.tildastatscroll == 'undefined' || (w.tildastatscroll != 'yes' && w.tildastatscroll != 'no')) {
                    w.tildastatscroll = $('#allrecords').data('tilda-statscroll') == 'yes' ? 'yes' : 'no'
                }
                try {
                    tmp = decodeURIComponent(w.location.search)
                } catch (e) {
                    tmp = w.location.search
                }
                if (tmp > '?') {
                    ...
                    if (tildaParams.pagequery.indexOf('utm_') != -1) {
                        ...
                        for (key in arParams) {
                            if (arParams[key]) {
                                ...
                                if (arPair.length > 1) {
                                    if (arPair[0] == 'utm_referrer' && tildaParams.referrer == '') {
                                        tildaParams.referrer = arPair[1]
                                    } else {
                ...
                if (w.tildastatscroll == 'yes') {
                    try {
                        w.onVisibilityWindowChange(function (visible) {
                            isWindowActive = (visible ? !0 : !1)
                        });
                        $('body').on('mousewheel,mousemove', t_throttle(function () {
                            isWindowActive = !0
                        }, 1000));
                        $('body').on('keypress', t_throttle(function () {
                            isWindowActive = !0
                        }, 1000));
                        $('body').on('click', t_throttle(function () {
                            isWindowActive = !0
                        }, 1000))
                    } catch (e) {
                    }
            ...
            case 'pageview':
                if (!tildaParams.page) {
                    ...
                    tildaParams.page = tmp + w.location.pathname;
                    if (w.location.hash && w.location.hash.indexOf('#!') == 0) {
                        tildaParams.page += w.location.hash
                    }
                }
                ...
                if (tildaParams.user_agent > '' && tildaParams.user_agent.indexOf('bot') != -1) {
                    break
                }
                $.ajax({
                    type: "POST",
                ...
                if (tildaParams.page && tildaParams.page.indexOf('tilda/scroll') == -1 && tildaParams.page.indexOf('tilda/readtime') == -1 && tildaParams.page.indexOf('tilda/click') == -1) {
            ...
            case 'readtime':
                try {
                    if (w.tildastatscroll == 'yes') {
                        if (isWindowActive) {
                            tildaParams.page = '/tilda/readtime/';
                            isWindowActive = !1;
                            w.tildastat('pageview')
                        }
                        w.setTimeout(function () {
                            w.tildastat('readtime')
                        }, 15000)
                    }
                } catch (e) {
                }
            ...
            case 'scroll':
                try {
                    if (w.tildastatscroll == 'yes') {
                        $(w).on('scroll', t_throttle(w.tildastat_scrollEvent, 500))
                    }
                } catch (e) {
                }
                break;
