function t_sldsInit(t, e) {
    ...
    var a = s.find(".t-slds__item"), i = a.length, d = a.filter(":first"), r = a.filter(":last"), l = $(window).width(),
        n = s.find(".t-slds__items-wrapper"), o = n.attr("data-slider-items-in-row"),
        _ = n.attr("data-slider-with-cycle"), c = n.attr("data-slider-stop");
    if ("true" == c) return !1;
    var f = o;
...
function t_slds_initSliderControls(t, e) {
    ...
    a.css({transform: "translateX(-" + d + "px)"}), s.find(".t-slds__arrow_wrapper").click(function () {
        var i = t_slds_getCurrentTranslate(s), d = a.attr("data-slider-animated"),
            r = parseFloat(a.attr("data-slider-pos"), 10), l = parseFloat(a.attr("data-slider-totalslides"), 10),
            n = "";
        if ("" == d) {
...
function t_slds_initAutoPlay(t, e, s, a) {
    var i = "object" == typeof t, d = i ? t : $("#rec" + t), r = d.find(".t-slds"),
        l = d.find(".t-slds__items-wrapper"), n = parseFloat(l.attr("data-slider-timeout")), o = "",
        _ = l.attr("data-slider-stop"), c = l.attr("data-slider-interval-id");
